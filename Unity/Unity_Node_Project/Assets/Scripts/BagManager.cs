...
public class BagManager : MonoBehaviour
{
    ...
    {
        StartCoroutine(GetBagContextsCoroutine(user_id));
    }
   IEnumerator GetBagContextsCoroutine(string user_id)
    {
        ...
        else
        {
            ...
            bagContenText.text = jsonResponse;
        }
    }
